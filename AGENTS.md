...
Working notes for coding agents in this repository, and the canonical copy:
Claude Code reads it through `CLAUDE.md`, Codex and other agents read it
directly. Personal working style lives in `CLAUDE.trudy.md`, not here; this
file is this repo's specifics.
